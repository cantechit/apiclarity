...
func (o *GetAPIEventsParams) validateSortKey(formats strfmt.Registry) error {
	...
	if err := validate.EnumCase("sortKey", "query", o.SortKey, []interface{}{"time", "method", "path", "statusCode", "sourceIP", "destinationIP", "destinationPort", "specDiffType", "hostSpecName"}, true); err != nil {
		return err
	}
